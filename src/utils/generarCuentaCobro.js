...
export const generarCuentaCobro = async (solicitud) => {
  try {
    ...
    doc
      .fontSize(11)
      .fillColor("black")
      .text(`Número de Cuenta de Cobro: ${solicitud.id_solicitud}`, 50, doc.y, {
        continued: false,
      })
    ...
    doc
      .fontSize(12)
      .fillColor("#1E3A8A")
      .text("DATOS DEL REFERENTE", 50, doc.y, {
        underline: true,
        continued: false,
      });
    ...
    doc
      .fontSize(11)
      .fillColor("black")
      .text(`Nombre: ${ref.nombre || "N/A"} ${ref.apellido || ""}`, 50, doc.y, {
        continued: false,
      })
      .text(`Correo: ${ref.correo_electronico || "N/A"}`, 50, doc.y, {
        continued: false,
      })
      .text(
        `Documento: ${solicitud.referente?.numero_documento_identidad || "N/A"}`,
        50,
        doc.y,
        { continued: false }
      );
    ...
    doc
      .fontSize(12)
      .fillColor("#1E3A8A")
      .text("DETALLES DEL COBRO", 50, doc.y, {
        underline: true,
        continued: false,
      });
    ...
    doc.fillColor("white").text("Descripción", startX + 10, startY + 7, {
      width: 280,
      continued: false,
    });
    ...
    doc
      ...
      .fillColor("black")
      .text(
        `${contadora.nombre || "Contadora"} ${contadora.apellido || ""}`,
        50,
        doc.y,
        {
          align: "center",
